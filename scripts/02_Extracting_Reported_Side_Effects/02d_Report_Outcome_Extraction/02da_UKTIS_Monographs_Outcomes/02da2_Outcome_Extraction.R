...
input_dir <- file.path(interim_data, "reported_outcomes/UKTIS_outcomes/1_Cleaned_PDFs")
output_dir <- file.path(interim_data, "reported_outcomes/UKTIS_outcomes/2_Extracted_Outcomes")
