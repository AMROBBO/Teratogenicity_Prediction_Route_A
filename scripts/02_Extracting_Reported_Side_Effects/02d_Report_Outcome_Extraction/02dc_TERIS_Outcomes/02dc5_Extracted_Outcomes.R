...
input_dir <- file.path(interim_data, "reported_outcomes/TERIS_outcomes/4_Combined_Outcomes")
output_dir <- file.path(interim_data, "reported_outcomes/TERIS_outcomes/5_Final_Outcomes")
